...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/font-awesome/css/font-awesome.css" rel="stylesheet">

    <!-- Page-Level Plugin CSS - Buttons -->
    <link href="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/css/plugins/social-buttons/social-buttons.css" rel="stylesheet">

    <!-- SB Admin CSS - Include with every page -->
    <link href="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/css/sb-admin.css" rel="stylesheet">
