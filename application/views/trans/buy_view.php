        ...
        <div class="col-lg-4 col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admin/purchase" role="form" >
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
              ...
              '<tr>
                  ...
                  <td>
                  <a href="'.base_url().'index.php/trans/hapus_transaksi/'.$data->id_jual.'" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                  </td>
              </tr>';
              }
              ?>
